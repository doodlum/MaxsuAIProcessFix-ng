...
namespace RE
{
	...
	public:
		...
		float							  GetDistanceTo2DPoint(float a_x, float a_y) const;
		float							  GetDistanceTo3DPoint(const NiPoint3 &a_pos) const;
		...
		float							  GetHeadingAngle(TESObjectREFR* targetref, bool b_unsign = true) const;
		...
		bool							  MoveToRef(TESObjectREFR* a_target);
